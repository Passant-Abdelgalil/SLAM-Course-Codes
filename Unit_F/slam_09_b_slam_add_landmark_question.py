...
class ExtendedKalmanFilterSLAM:
    ...
    def add_landmark_to_state(self, initial_coords):
        ...
        self.state = concatenate((self.state, array(list(initial_coords))))
        
        newCovariance = zeros((len(self.covariance)+2, len(self.covariance)+2))
        newCovariance[0:len(self.covariance), 0:len(self.covariance)] = self.covariance
...
if __name__ == '__main__':
    ...
    f = open("Unit_F/ekf_slam_add_landmarks.txt", "w")
